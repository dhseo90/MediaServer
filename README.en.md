...
- Latest published GitHub Release: [v3.6.0](https://github.com/dhseo90/MediaServer/releases/tag/v3.6.0)
- Current source version: `3.7.0`
- v3.6.0 public status: source-only GitHub Release. Binary, runtime, and model bundles are not included.
- Current source roadmap: `v3.7.0 Site-Aware Operations and Safe Runbook Control Plane`
...
- Latest published release: `v3.6.0` Operations Simulation and Safe Apply Readiness, source-only.
- Current source: `3.7.0` Site-Aware Operations and Safe Runbook Control Plane.
- v3.7 roadmap: extends v3.6 simulation and safe-apply readiness into site,
  source-group, client-view, and runbook approval boundaries so operators can
  review impact and blockers across multiple sites in a controlled sequence.
- Latest published baseline: v3.6.0 is the published source baseline, while
  v3.7.0 Site-Aware Operations and Safe Runbook Control Plane is the current
  source roadmap.
...
- Latest published release notes: [v3.6.0](https://github.com/dhseo90/MediaServer/releases/tag/v3.6.0)
- Current source roadmap: `v3.7.0 Site-Aware Operations and Safe Runbook Control Plane` in
