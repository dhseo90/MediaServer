...
- 1차 완료: Runtime Dashboard trend/stale/cleanup warning, scenario rule payload의 runtime per-rule 설정 연결, ReEntry와 IntrusionAfterLineCrossing의 룰 편집 UI 선택/저장 템플릿.
