...
- 직전 published baseline: `v3.3.0 Live Source Reliability Workspace`
- 현재 소스 버전: `3.4.0`
...
- 공개 문서/대표 asset 기준: `README.md`, `README.en.md`, `docs/README.md`,
  `docs/en/README.md`, `docs/ui-guide.md`, `docs/assets/ui/README.md`는 v3.4
  source roadmap과 v3.4 published baseline을 정렬하고 직전 v3.3 baseline은
