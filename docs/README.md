...
- 직전 published baseline: `v3.1.0 Encoded Event Clip and Safe Sharing Expansion`
- 현재 소스 버전: `3.3.0`
...
- 공개 문서/대표 asset 기준: `README.md`, `README.en.md`, `docs/README.md`,
  `docs/en/README.md`, `docs/ui-guide.md`, `docs/assets/ui/README.md`는 v3.3
  source roadmap과 v3.2 published baseline을 분리하고 직전 v3.1 baseline은
