...
- 직전 published baseline: `v3.6.0 Operations Simulation and Safe Apply Readiness`
- 현재 소스 버전: `3.8.0`
...
- 공개 문서/대표 asset 기준: `README.md`, `README.en.md`, `docs/README.md`,
  `docs/en/README.md`, `docs/ui-guide.md`, `docs/assets/ui/README.md`는 v3.8
  source roadmap과 latest published v3.7 baseline을 분리하고 직전 v3.6 baseline은
