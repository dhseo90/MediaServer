...
현재 README 대표 이미지는 제품 shell 설명용입니다. 현재 source tree는 `v3.6.0`
Operations Simulation and Safe Apply Readiness를 가리키고, 최신 공개 GitHub Release는
`v3.6.0` Operations Simulation and Safe Apply Readiness를 가리킵니다. 이 이미지를 v3.6.0 source baseline,
...
- v3.6.0 source roadmap과 v3.6.0 published source-only baseline을 정렬하고,
