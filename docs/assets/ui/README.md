...
Live Source Reliability Workspace를 가리키고 최신 공개 GitHub Release는 `v3.2.0`
Operations Resolution Workspace를 가리키지만, 이 이미지를 v3.3.0 source baseline,
...
- v3.3.0 source roadmap과 v3.2.0 published source-only baseline을 분리 정렬하고,
