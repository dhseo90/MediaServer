...
`v3.5.0` Live Operations Control Plane을 가리킵니다. 이 이미지를 v3.6.0 source baseline,
...
- v3.6.0 source roadmap과 v3.5.0 published source-only baseline을 분리하고,
  직전 v3.4.0 baseline은 historical reference로만 둡니다.
