...
- 현재 source 개발 로드맵: [`v4.1.0 Recording Foundation`](./v410-v49-recording-search-roadmap.md).
  ...
  구형 소비자·출처·공개 설명 정합과 S10 제품287파일 고정을 마쳤으며 S11 최종 단기·30분·UI·120분은 남는다.
...
| V410-S10 | 시간·식별·저장 기반 보강 | P0 | 부분 완료 | 현행 생산·소비·저장/복구·실제 이벤트 통합·HW 영향 회귀 마감. PREP 검토 원장 재결속·legacy 정리·코드 고정은 남음 |
