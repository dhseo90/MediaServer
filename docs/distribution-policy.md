...
- ONNX Runtime package와 YOLO/model binary는 기본 release asset에 포함하지 않습니다.
...
| Runtime/model 포함 bundle | GStreamer/FFmpeg/plugin/ONNX Runtime/model까지 복사 | 별도 법무/라이선스 검토, source offer, license text, attribution |
