...
- Latest published baseline: `v3.4.0 Operations Continuity Drill Workspace`
- Previous published baseline: `v3.3.0 Live Source Reliability Workspace`
- Current source version: `3.4.0`
- v3.4.0 public status: source-only GitHub Release. Binary, runtime, and model
...
- Public docs/assets baseline: `README.md`, `README.en.md`, `docs/README.md`,
  ...
  align the v3.4 source roadmap with the v3.4 published baseline while
  keeping the v3.3 baseline as historical reference. Representative
...
- The current source tree tracks the `v3.4.0 Operations Continuity Drill Workspace`
  roadmap baseline. Feature completion still requires the corresponding v3.4
