...
- Latest published baseline: `v3.6.0 Operations Simulation and Safe Apply Readiness`
- Previous published baseline: `v3.5.0 Live Operations Control Plane`
- Current source version: `3.7.0`
- v3.6.0 public status: source-only GitHub Release. Binary, runtime, and model
...
- Public docs/assets baseline: `README.md`, `README.en.md`, `docs/README.md`,
  ...
  separate the v3.7 source roadmap from the v3.6 published baseline while
  keeping the v3.5 baseline as historical reference. Representative
...
- The current source tree tracks the `v3.7.0 Site-Aware Operations and Safe Runbook Control Plane`
  roadmap baseline. Feature completion still requires the corresponding v3.7
