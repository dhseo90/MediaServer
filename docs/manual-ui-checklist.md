...
열어 `Ops Continuity Drill Workspace`, `Approval-Gated Recovery Checklist`, `Client-safe Maintenance Digest`, `Drill Evidence Export and Cleanup Manifest`와 비노출 경계를 확인해야 합니다.
