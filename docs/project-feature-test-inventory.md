...
| B08-R01 | 정확한 이전 snapshot 회수 | 예정: target 권위·기존 파일 보존·재개방 | 보존·복구 변경 영향 판정 | 녹화 누적 직접 영향 | 비대상: CLI |
| B08-R02 | 회수 중단·손상·reader 반례 | 예정: PREPARED/PUBLISH_INTENT·바뀐 파일·관측 경쟁 | 보존·복구 변경 영향 판정 | 녹화 누적 직접 영향 | 비대상: CLI |
