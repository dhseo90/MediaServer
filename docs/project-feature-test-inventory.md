...
실행 전 등록이다. caller 소유 새 stage의 비공개 후보만 생성하며 marker/manifest 게시·복구는 후속이다.

| ID | 확인 항목 | 안정화 | 30분 | 120분 | UI |
| --- | --- | --- | --- | --- | --- |
| B04-C01 | 소유·원본 보존 | 예정: 미개방·managed·stage 소유·실패 출력 불변 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-C02 | domain·snapshot | 예정: V1/V2·16종 값·예약·accepted·pending hold 독립 대조 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-C03 | 표현·물리 재시도 | 예정: plain/blank/compressed/receipt·canonical 사본·순서 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-C04 | 출력 조각·누적 | 예정: 크기/행/단일행/빈 원장/65조각 체인·분할 동등성 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-C05 | 오류 격리 | 예정: 뒤 행 domain·ID·순서·손상, 후보 미공개·원본 불변 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-C06 | 파일·지원 | 예정: O_EXCL·I/O·unsafe stage·미지원·생성 소유 보고 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-C07 | cold·활성 상세 | 예정: latest/provenance·active 보호·inactive 해제·공개 authority 없음 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
