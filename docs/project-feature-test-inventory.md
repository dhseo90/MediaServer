...
| LP26-O06 | 녹화 장시간 저장량 원인 구분 | 격리 root 구성별 합계·상한 직전/실패 측정, symlink·hardlink 거부와 비민감 출력 자체검사 | 비대상: 도구 자체검사 | 동일 120분의 측정 근거로 사용, 실행 별도 | 비대상: UI 없음 |
...
| LP22-R04 | 다음요청 재획득 | 요청간재사용없음·현재원문검사 | S11최종cut판정 | S11최종cut판정 | 비대상: 내부소유 |
| LP22-R05 | 정리·보호 | 성공/실패/예외hold0·상세비상주 | S11최종cut판정 | S11최종cut판정 | 비대상: 내부소유 |
