...
소비자 보호 뒤 실행할 기본 구성 단위의 사전등록이다. 내부 집중 PASS로 실제 앱/장시간을 대체하지 않는다.

| ID | 확인 항목 | 안정화 | 30분 | 120분 | UI |
| --- | --- | --- | --- | --- | --- |
| B05-R01 | B default/fresh | PASS: marker·current·예약·재open | 미실행: 고정 뒤 판정 | 미실행: 녹화 최종 | 비대상: 내부 구성 |
| B05-R02 | V1 source 보존 | PASS: 기존 bytes/ID·fresh 조회 | 미실행: 고정 뒤 판정 | 미실행: 녹화 최종 | 비대상: 내부 구성 |
| B05-R03 | 시작 복구 | PASS: PREPARED/target·불확실 거부 | 미실행: 고정 뒤 판정 | 미실행: 녹화 최종 | 비대상: 내부 구성 |
| B05-R04 | 지원 구성 | PASS: core 지원 조합·SQLite 경계; 미지원 전체 서버 미실행 | 미실행: 고정 뒤 판정 | 미실행: 녹화 최종 | 비대상: 내부 구성 |
| B05-R05 | 경로·owner | PASS: 허용alias·symlink/fork 거부 | 미실행: 고정 뒤 판정 | 미실행: 녹화 최종 | 비대상: 내부 구성 |
| B05-R06 | 공개 상태 | PASS: mode/degraded·채널 필터; auth 구현 무변경 | 미실행: 고정 뒤 판정 | 미실행: 녹화 최종 | 실제 상태 UI: 후속 최종 |
| B05-R07 | 수용 범위 | PASS: 형식/행·자연count/ordinal | 미실행: 고정 뒤 판정 | 미실행: 녹화 최종 | 비대상: 내부 구성 |

## S11 B-05 소비자 보호 연결

실행 전 정의는 중앙 테스트 기록의 B05-P01~P05다. 기본 runtime 전환 전의 내부 소비자 단위다.

| ID | 확인 항목 | 안정화 | 30분 | 120분 | UI |
| --- | --- | --- | --- | --- | --- |
| B05-P01 | finalize+hold | PASS: 단일 변경·SQL 실패·fresh 복구 | 미실행: 고정 후 판정 | 미실행: 녹화 최종 | 비대상: 내부 저장 |
| B05-P02 | read-only 임시 보호 | PASS: acquire/release·rollback·범위 | 미실행: 고정 후 판정 | 미실행: 녹화 최종 | 비대상: 내부 저장 |
| B05-P03 | 보호 소유 결박 | PASS: owner/파일/cache/PID·중단 상태 거부 | 미실행: 고정 후 판정 | 미실행: 녹화 최종 | 비대상: 내부 저장 |
| B05-P04 | 예약 소비자 | PASS: writer/파생 예약·retry·V1 | 미실행: 고정 후 판정 | 미실행: 녹화 최종 | 비대상: 내부 저장 |
| B05-P05 | 재생·이벤트·보존 교차 | PASS: pin/hold·삭제·참조·cold | 미실행: 고정 후 판정 | 미실행: 녹화 최종 | 실제 UI: 후속 최종 |

## S11 B-04 게시·중단 복구

실행 전 등록 후 게시·중단 복구165개와 관련 회귀1,409개·전체 빌드가 통과했다.
후보 PASS와 실제 게시/복구 PASS를 구분하며 runtime 기본 활성화·누적/실제 앱 결과가 아니다.

| ID | 확인 항목 | 안정화 | 30분 | 120분 | UI |
| --- | --- | --- | --- | --- | --- |
| B04-T01 | 정상 전환·권위 | PASS: 원본/B 동등·old/recovery owner 차단·fresh 쓰기·기존 ID/경로 | 미실행: 고정 뒤 판정 | 미실행: 녹화 최종 | 비대상: 내부 저장 |
| B04-T02 | crash 내구 경계 | PASS: receipt/link/marker/manifest 중단·정리 재중단 | 미실행: 고정 뒤 판정 | 미실행: 녹화 최종 | 비대상: 내부 저장 |
| B04-T03 | PREPARED 복구 | PASS: fresh source/domain·inode/hash·부재·predecessor 결박 | 미실행: 고정 뒤 판정 | 미실행: 녹화 최종 | 비대상: 내부 저장 |
| B04-T04 | 승격 소유 | PASS: 정확 nlink2만 처리·foreign/불명확 보존 | 미실행: 고정 뒤 판정 | 미실행: 녹화 최종 | 비대상: 내부 저장 |
| B04-T05 | 불확실 상태 | PASS: intent·손상·조회오류·모순 거부·유효 target 복구 | 미실행: 고정 뒤 판정 | 미실행: 녹화 최종 | 비대상: 내부 저장 |
| B04-T06 | 회전 연결 | PASS: checkpoint 중단·live 소유 정리·기존 SQL/비용/guard | 미실행: 고정 뒤 판정 | 미실행: 녹화 최종 | 비대상: 내부 저장 |
...
| B04-R07 | 원자 교체 파일 결박 | PASS: replacement marker·predecessor file 필수/금지·canonical bytes·고유 inode. R01~06 확장 형식 재검증 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-R08 | store ID 호환 | PASS: 기존 점/콜론 ID 수용·경로 표현 거부·고정 구성 파일명 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
...
| ID | 확인 항목 | 안정화 | 30분 | 120분 | UI |
| --- | --- | --- | --- | --- | --- |
| B04-C01 | 소유·원본 보존 | PASS: 미개방·managed·stage 소유·실패 출력 불변 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-C02 | domain·snapshot | PASS: V1/V2·16종 값·예약·accepted·pending hold 독립 대조 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-C03 | 표현·물리 재시도 | PASS: plain/blank/compressed/receipt·canonical 사본·순서 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-C04 | 출력 조각·누적 | PASS: 크기/행/단일행/빈 원장/65조각 체인·분할 동등성 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-C05 | 오류 격리 | PASS: 뒤 행 domain·ID·순서·손상, 후보 미공개·원본 불변 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-C06 | 파일·지원 | PASS: O_EXCL·I/O·unsafe stage·미지원·동일bytes inode 교체·생성 소유 보고 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-C07 | cold·활성 상세 | PASS: latest/provenance·active 보호·inactive 해제·공개 authority 없음 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |

## S11 B-04 원문 방문 세션

실행 전 등록이다. 준비 세션의 소유·freeze만 검증하며 전환 게시·복구와 실제 서버 활성화는 후속이다.

| ID | 확인 항목 | 안정화 | 30분 | 120분 | UI |
| --- | --- | --- | --- | --- | --- |
| B04-S01 | 원문·cold view | PASS: 정상·빈 원장·blank·비정규 outer·wrapper·retry·whole SHA/offset 불변14개 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-S02 | 쓰기 freeze·읽기 유지 | PASS: 모든 원장 변경·중첩 거부, cold 취득/deadlock 경계5개 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-S03 | 실패 후 정리 | PASS: false/throw·summary 불변·freeze 해제·재방문5개 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-S04 | 권위 변조 거부 | PASS: 원문/marker/root/attachment/FD·lease 변경·poison10개 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-S05 | 소유·선수조건 | PASS: B/pending/foreign/no attachment/fork 거부5개 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-S06 | 지원·영향 회귀 | PASS: backend/crypto 경계7개·Journal78/Catalog249/append219/공개읽기106/회전123; build 기록은 중앙 참조 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-S07 | snapshot 내부 값 분리 | PASS: 공개 export 권위 거부·exact bytes·명시 store 대조8개(2지원 조합) | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |

## S11 B-04 기존 원문 전환 준비

독자: 녹화 저장 구현·검증 담당자. 수명: 형식 전환부터 S11 고정까지. 실행 전 등록이다.
이 단위는 읽기·준비의 envelope 경계이며 Catalog 전환/게시 완료가 아니다.

| ID | 확인 항목 | 안정화 | 30분 | 120분 | UI |
| --- | --- | --- | --- | --- | --- |
| B04-P01 | 기존 표현 수용 | PASS: canonical/비정규 outer/빈 LF/원본 offset 3개 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-P02 | 압축·receipt·순서 | PASS: wrapper·originalSha256·동일 ID 물리 재시도·ordinal 1개 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-P03 | 실패·출력 경계 | PASS: 손상·미지원·미완결·방문자 거부·정확한 행 상한·summary 불변 10개 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-P04 | FD·원본 결박 | PASS: 다른 FD·교체·동일 길이 변경·offset/전체 SHA 8개 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-P05 | 한 행씩 처리 | PASS: 1/4096행의 callback 크기·순서·독립 전체 SHA 2개; RAM 실측 아님 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B04-P06 | 지원·회귀·정리 | PASS: 빈 입력/crypto-off 2개·새 전체 빌드·cleanup; 불변 기존 회귀 유지 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |

## S11 B-03 세대 회전

독자: 녹화 저장 구현·검증 담당자. 수명: B 회전 연결부터 S11 고정까지. 실행 전 등록이다.

| ID | 확인 항목 | 안정화 | 30분 | 120분 | UI |
| --- | --- | --- | --- | --- | --- |
| B03-C01 | 회전·재Open | PASS: 수동/자동·두 세대·독립 current/SQL 16개 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B03-C02 | 안정 참조 | PASS: ID/최초 ordinal/identity·cold 검증·다른 owner 거부 8개 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B03-C03 | 게시 실패 격리 | PASS: 준비·rename 전/후·SQL 실패·엄격 복구 44개 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B03-C04 | 과거 비용 비증가 | PASS: 고정 현재/증분·과거 상세 증가·파일 불변 4개; 누적/HTTP 판정 아님 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B03-C05 | 작업·예약·상한 | PASS: 진행 작업·복수 출력·invalid 무회전·admission/overflow 38개 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B03-C06 | 지원·영향 회귀 | PASS: 기존 B/v1·미지원 차단 13개, 영향 1,340 assertion·빌드·정리 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |

## S11 B-03 증분 저장

독자: 녹화 저장 구현·검증 담당자. 수명: B 쓰기 구현부터 S11 고정까지. 아래는 실행 전 등록이다.

| ID | 확인 항목 | 안정화 | 30분 | 120분 | UI |
| --- | --- | --- | --- | --- | --- |
| B03-W01 | append·예약·재Open | PASS: 독립 current/원본 byte 대조70개 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B03-W02 | 충돌·쓰기 전 거부 | PASS: ID/tuple·domain·순서·상한·owner와 무변경40개 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B03-W03 | durable 실패 격리 | PASS: poison·엄격 새 owner 복구·미완결 거부53개, 초기 오류 보존 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B03-W04 | 증분 SQL·참조 수명 | PASS: 변경 key·기존 링크/권위·과거 파일 불변38개; 누적 계측은 후속 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |
| B03-W05 | 지원·영향 회귀 | PASS: 기본 read-only·v1·B finalize+hold 사전거부16개, 영향 회귀966개·빌드 | 미실행: 고정 후 영향 판정 | 미실행: 녹화 전용 최종 | 비대상: 내부 저장 |

## S11 B-03 내구 기록 전 검증

독자: 녹화 저장 구현자. 수명: B 증분 쓰기·회전 구현부터 S11 코드 고정까지.
비변경 검증 경계·영향 회귀는 통과했으며 실제 B 쓰기는 계속 차단한다.

| ID | 확인 항목 | 안정화 | 30분 | 120분 | UI |
| --- | --- | --- | --- | --- | --- |
| B03-V01 | 정상·중복 domain 수용 | PASS: 독립 기대 결과·실제 적용 대조130개 | 미실행: B 코드 고정 뒤 영향 판정 | 미실행: 녹화 전용 최종 검증 | 비대상: 내부 저장 |
| B03-V02 | 오류 무기록·무변경 | PASS: ID·예약·참조·domain·상태 오류 뒤 current/IDs/revision/hold·원장/SQL 불변296개 | 미실행: B 코드 고정 뒤 영향 판정 | 미실행: 녹화 전용 최종 검증 | 비대상: 내부 저장 |
| B03-V03 | 예약 인덱스 검증 분리 | PASS: namespace·tuple/time·순서·복수 출력 거부 뒤 불변72개 | 미실행: B 코드 고정 뒤 영향 판정 | 미실행: 녹화 전용 최종 검증 | 비대상: 내부 저장 |
| B03-V04 | 영향 회귀·쓰기 차단 | PASS: 지원 조합·쓰기 차단12개, scratch/공개읽기/Journal/Catalog/파생 작업515개·전체 빌드 | 미실행: B 코드 고정 뒤 영향 판정 | 미실행: 녹화 전용 최종 검증 | 비대상: 내부 저장 |
