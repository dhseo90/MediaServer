...
| UI-113 | PASS | /ops/dashboard | inspect-action-execution-deferral | action execution decision shows all action writes deferred | control action executed and expected UI state captured |
