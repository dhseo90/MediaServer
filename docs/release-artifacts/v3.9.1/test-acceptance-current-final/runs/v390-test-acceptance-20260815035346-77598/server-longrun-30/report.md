...
| --- | --- | --- | --- |
| preflight | PASS | validate duration/output-dir/tools | ${REPO_ROOT}/docs/release-artifacts/v3.9.1/test-acceptance-current-final/runs/v390-test-acceptance-20260815035346-77598/server-longrun-30/preflight.log |
| build | PASS | ./server.sh build | ${REPO_ROOT}/docs/release-artifacts/v3.9.1/test-acceptance-current-final/runs/v390-test-acceptance-20260815035346-77598/server-longrun-30/build.log |
| seed | PASS | write ${REPO_ROOT}/docs/release-artifacts/v3.9.1/test-acceptance-current-final/runs/v390-test-acceptance-20260815035346-77598/server-longrun-30/seed.json | ${REPO_ROOT}/docs/release-artifacts/v3.9.1/test-acceptance-current-final/runs/v390-test-acceptance-20260815035346-77598/server-longrun-30/seed.log |
| start-server | PASS | ./server.sh verify-predev --soak-minutes 30 --skip-build --fail-fast --summary-file ${REPO_ROOT}/docs/release-artifacts/v3.9.1/test-acceptance-current-final/runs/v390-test-acceptance-20260815035346-77598/server-longrun-30/predev-summary.json --report-file ${REPO_ROOT}/docs/release-artifacts/v3.9.1/test-acceptance-current-final/runs/v390-test-acceptance-20260815035346-77598/server-longrun-30/predev-report.md --report-html-file ${REPO_ROOT}/docs/release-artifacts/v3.9.1/test-acceptance-current-final/runs/v390-test-acceptance-20260815035346-77598/server-longrun-30/predev-report.html | ${REPO_ROOT}/docs/release-artifacts/v3.9.1/test-acceptance-current-final/runs/v390-test-acceptance-20260815035346-77598/server-longrun-30/soak-case-loop.log |
...
| cleanup | PASS | measured cleanup phase | ${REPO_ROOT}/docs/release-artifacts/v3.9.1/test-acceptance-current-final/runs/v390-test-acceptance-20260815035346-77598/server-longrun-30/cleanup.log |
| report | PASS | report phase | ${REPO_ROOT}/docs/release-artifacts/v3.9.1/test-acceptance-current-final/runs/v390-test-acceptance-20260815035346-77598/server-longrun-30/report.log |
