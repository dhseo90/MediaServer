...
| 2026-05-25 | project-stability-goal-20260525 | 안정화 테스트 | UI CSS overflow fix 후 `build`, auth bootstrap/users/routes, ops/client UI smoke+screenshot, rule UI, `git diff --check` 재실행 | PASS | 0 | 1,330,050 | 1,330,050 | 155m 24s goal snapshot | Codex goal usage snapshot during evidence update | `/var/folders/k0/qhmr6zdx11q0_41wfx4dsd200000gn/T/media_server_ops-client-ui-1779681934299-85209`, [manual-ui-result-2026-05-25-project-test.md](manual-ui-result-2026-05-25-project-test.md) |
| 2026-05-25 | project-predev-30min-goal-20260525 | 30분 soak | retry fix 후 `./server.sh verify-predev --soak-minutes 30`; integrated smoke, 22 soak iterations, pass 119 / fail 0 / skip 1 | PASS | 0 | 1,330,050 | 1,330,050 | 155m 24s goal snapshot | Codex goal usage snapshot during evidence update | `/tmp/media_server_predev-1779676050-41836_summary.json`, `/tmp/media_server_predev-1779676050-41836_report.md`, `/tmp/media_server_predev-1779676050-41836_report.html`, [manual-ui-result-2026-05-25-project-test.md](manual-ui-result-2026-05-25-project-test.md) |
| 2026-05-25 | manual-ui-project-test-20260525 | UI 풀테스트 | 인앱 브라우저 route/auth/client live/VA event coverage, `/ops/events` pagination, 72개 responsive matrix 재검수. 전체 219개 UI 기능 ID 개별 조작은 완료하지 않음 | FAIL | 0 | 1,330,050 | 1,330,050 | 155m 24s goal snapshot | Codex goal usage snapshot during evidence update | [manual-ui-result-2026-05-25-project-test.md](manual-ui-result-2026-05-25-project-test.md), `/private/tmp/media_server_manual_ui_20260525_RIbb3k/evidence`, `/private/tmp/media_server_manual_ui_20260525_RIbb3k/events.jsonl` |
...
Not run for `project-predev-30min-goal-20260525`: 120분 longrun.
Not run for `manual-ui-project-test-20260525`: full 219-feature inventory completion, 120분 longrun.
