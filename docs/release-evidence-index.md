...
| V390-REVIEW4-56 exact 424 product workflow design | `media-server.v390-ui-case-native-workflow.v2`, exact 424 class 287/15/32/43/45/2, `./server.sh verify-v390-ui-native-exact-cases`, `./server.sh verify-v390-ui-native-exact-cases-contract`, plan-only runner | [release-test-records.md](./release-test-records.md) `V390-REVIEW4-56 final`, contract, plan-only 424 | [release-test-records.md](./release-test-records.md) `V390-REVIEW4-56 미실행 경계` | actual input/control/action/state/runtime-required readback/cleanup과 source anchor/file digest/secret/inverse/role negative 경계를 검증합니다. Actual browser exact 424, Policy v4 eligibility, 30분/120분, release action evidence가 아닙니다 |
