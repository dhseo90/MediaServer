...
| v3.9.0 (17) Development 16 / REVIEW4-63 accountable deferred product owner sign-off | `./server.sh verify-v390-deferred-product-owner-signoff`, `./server.sh verify-v390-truthfulness-status-vocabulary`, `test/fixtures/v390_deferred_product_owner_signoff.json`, `.github/CODEOWNERS`, [project-feature-test-inventory.md](./project-feature-test-inventory.md) `SAFE-214`/`OPS-181` | [release-test-records.md](./release-test-records.md) `V390-REVIEW4-63 owner accountability final`, `V390-REVIEW2-35 truthful status vocabulary final`; actual owner `@dhseo90`, production restore 포함 exact 5개, mixed capability truth, source SHA/route/UI/boundary, `post-v3.9-unassigned` dependency | [release-test-records.md](./release-test-records.md) `V390-REVIEW4-63 UI/30분/120분/field 미실행` | `accountable-owner-decision-record`, `decision-record-complete-capabilities-mixed`, `decision-only-not-implementation-or-execution-evidence`; Re-ID experimental source 구현을 보존하며 실제 제품 실행/field/release PASS가 아닙니다 |
| v3.9.0 (17) Development 17 structure stabilization readiness | `./server.sh verify-v390-structure-stabilization-readiness`, `./server.sh verify-v390-truthfulness-status-vocabulary`, `test/fixtures/v390_structure_stabilization_readiness.json`, [project-feature-test-inventory.md](./project-feature-test-inventory.md) `SAFE-215`/`OPS-182` | [release-test-records.md](./release-test-records.md) `Development 17 structure readiness final`, `V390-REVIEW2-35 truthful status vocabulary final`, `V390-REVIEW4-51 scope decision RED/final` | [release-test-records.md](./release-test-records.md) `Development 17 실제 refactor/UI/longrun` | `approved-scheduled-after-review4-50-63`, implementation `not-executed`, `approved-decision-contract-not-refactor-evidence`; REVIEW4-64/65 완료가 아닙니다 |
...
| v3.9.0 current source/readiness reconciliation | current inventory 986개, current acceptance source, Step 20 Development 15~18 및 Review2-21/35 companion verifier, current review approved/closed 상태 | [release-test-records.md](./release-test-records.md) v3.9.0 `v390 current user approval closure reconciliation`, `V390-REVIEW4-61 current acceptance policy supersession`, `V390-REVIEW4-62 self-contained acceptance final`; canonical `./server.sh verify-v390-test-acceptance-bundle --output-dir docs/release-artifacts/v3.9.0/test-acceptance-current-final` | historical source `8fe583d8`의 974개/26-command evidence와 current final 안정화·30분·120분·UI 미실행 기록 | Historical 결과를 current PASS로 재사용하지 않습니다. Acceptance가 throwaway runtime/account/storage-state/browser/cleanup을 자체 소유해도 clean worktree에서 안정화→feature gate→30분→exact 424 Policy v4 UI→AGENTS 7.6.2 판정상 필요한 120분→raw cleanup/final integrity actual evidence가 필요합니다. Trigger 없는 `--run-120`은 거부합니다 |
...
| V390-REVIEW4-62 self-contained acceptance | `scripts/internal/v390_acceptance_ui_environment.mjs`, `scripts/internal/v390_ui_case_runtime.mjs`, acceptance/native runner·adapter, `./server.sh verify-v390-test-acceptance-bundle-contract`, `./server.sh verify-v390-ui-native-exact-cases-contract`, `./server.sh verify-v390-final-evidence-integrity-contract` | [release-test-records.md](./release-test-records.md) `V390-REVIEW4-62 contract final`, `V390-REVIEW4-62 semantic refresh final` | [release-test-records.md](./release-test-records.md) `V390-REVIEW4-62 미실행 경계` | Acceptance가 throwaway server/port/account/role-state/browser dependency와 cleanup을 직접 소유하고 runner가 typed form 15건, persisted mutation 35건의 product lifecycle·authoritative readback·aggregate restore를 수행합니다. Fixture·contract·plan-only는 actual 30분/exact 424/80 visual/120분 PASS가 아닙니다 |
