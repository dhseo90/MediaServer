...
| v3.9.0 Step 25 / V390-ADD1-11 full-feature exact-ID UI automation coverage matrix | `./server.sh verify-v390-ui-automation-coverage --output-dir <path>`, `./server.sh verify-v390-ui-automation-coverage-contract`, [v390-ui-automation-coverage-matrix.md](./v390-ui-automation-coverage-matrix.md), exact UI test ID 424개 | historical 8-case 및 423+negative 1/unsupported 0 classification은 audit-only로 보존 | current REVIEW4-56~60 workflow/readiness 미완성, execution pass 0/not-run 424 | Exact 424 ID 집합은 유지하지만 기존 matrix PASS/readiness를 current UI workflow 또는 UI 풀테스트 PASS로 승격하지 않습니다 |
...
| V390-REVIEW3-47 historical exact readiness/historical isolation | historical coverage policy/state, native 423+negative 1/unsupported 0, pass 0/not-run 424, audit-only historical deny | [release-test-records.md](./release-test-records.md) `V390-REVIEW3-47 current exact readiness/historical isolation RED/final` | REVIEW4-56~60 current workflow/readiness 및 actual exact 424/30분/120분 미실행 | Historical isolation 경계는 유지하지만 기존 readiness/contract를 current UI readiness나 PASS로 승격하지 않습니다 |
