...
| v3.9.0 Step 25 / V390-ADD1-11 full-feature exact-ID UI automation coverage matrix | `./server.sh verify-v390-ui-automation-coverage --output-dir <path>`, `./server.sh verify-v390-ui-automation-coverage-contract`, [v390-ui-automation-coverage-matrix.md](./v390-ui-automation-coverage-matrix.md), exact UI test ID 424개, current state fixture | historical 8-case 결과는 [release-test-records.md](./release-test-records.md) `V390-ADD1-11 full-feature exact-ID correction final`에 audit-only로 보존 | current readiness native 423+negative 1/unsupported 0, execution pass 0/not-run 424 | Matrix gate는 `exact-native-ready-current-not-run` readiness를 기록하며 actual UI 풀테스트 PASS로 승격하지 않습니다 |
...
| V390-REVIEW3-49 structure execution scope decision | `test/fixtures/v390_structure_execution_scope_decision.json`, graph SHA/metrics, four defer factors, v3.9 `graph-guard-decision-only`/v4.0.0 ordered execution | [release-test-records.md](./release-test-records.md) `V390-REVIEW3-49 structure execution scope decision RED/final` | v4 branch/refactor/UI/30분/120분 미실행 | Readiness 8/0은 decision source binding입니다. Decision-recorded를 structure implementation/refactor complete로 승격하지 않습니다 |
...
| V390-REVIEW3-47 current exact readiness/historical isolation | coverage policy/state v4/v2, native 423+negative 1/unsupported 0, pass 0/not-run 424, audit-only historical deny | [release-test-records.md](./release-test-records.md) `V390-REVIEW3-47 current exact readiness/historical isolation RED/final` | actual exact 424/30분/120분 미실행 | Current 6/0, coverage 12/0, Policy 18/0 contract가 readiness/execution 분리와 historical realpath/source-kind 거부를 확인합니다. Readiness/contract를 UI PASS로 승격하지 않습니다 |
