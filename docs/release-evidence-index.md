...
| v3.9.0 R3 test acceptance bundle | `./server.sh verify-v390-test-acceptance-bundle`, `./server.sh verify-v390-test-acceptance-bundle-contract`, [stream-verification.md](./stream-verification.md), [project-feature-test-inventory.md](./project-feature-test-inventory.md) `OPS-179`/`SAFE-212` plus R1/R2 preserved summary command set | [release-test-records.md](./release-test-records.md) v3.9.0 `v390 R3 test acceptance bundle dry-run final`; R1/R2 preserved summary paths are `docs/release-artifacts/v3.9.0/server-longrun-30min-final/summary.json` and `docs/release-artifacts/v3.9.0/ui-automation-playwright-final/summary.json` | [release-test-records.md](./release-test-records.md) v3.9.0 `v390 R3 actual acceptance bundle` | UI 풀테스트 직접 조작 PASS, 120분 PASS, published metadata, release action evidence |
