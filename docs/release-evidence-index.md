...
| v3.9.0 R2 / V390-ADD1-07 UI automation exact case runner | `./server.sh verify-v390-ui-automation`, `./server.sh verify-v390-ui-automation-report`, `./server.sh verify-v390-ui-automation-runner-contract`, `docs/release-artifacts/v3.9.0/ui-automation-case-completeness-final/summary.json`, [stream-verification.md](./stream-verification.md), [project-feature-test-inventory.md](./project-feature-test-inventory.md) `OPS-169`/`SAFE-202` and exact `UI-108`~`UI-115` 8-case route/control/action/state/failure evidence | [release-test-records.md](./release-test-records.md) `V390-ADD1-07 actual UI case completeness final`, `V390-ADD1-07 exact case contract final` | [release-test-records.md](./release-test-records.md) `V390-ADD1-07 UI 풀테스트`, Step 8 native adapter, Step 9 visible DOM assertion | UI 풀테스트 직접 조작 evidence, native adapter evidence, marker-free visible DOM evidence, 30분/120분, published metadata, release action evidence |
