...
| v3.9.0 R1 / V390-ADD1-10 server longrun first-fail runner | `./server.sh verify-v390-server-longrun`, `./server.sh verify-v390-server-longrun-runner-contract`, `./server.sh verify-predev --fixture-first-fail`, [stream-verification.md](./stream-verification.md), [project-feature-test-inventory.md](./project-feature-test-inventory.md) `OPS-168`/`SAFE-201` | [release-test-records.md](./release-test-records.md) v3.9.0 `v390 R1 server longrun runner final`, `V390-ADD1-10 longrun first-fail diagnostics final`, `v390 30분 longrun R1 runner actual final` | [release-test-records.md](./release-test-records.md) v3.9.0 `V390-ADD1-10 actual 30/120 duration`, `v390 R1 실제 120분 longrun` | 새 code 기준 real 120-minute duration evidence를 포함한 실제 30/120분, UI 풀테스트 직접 조작, published metadata, release action evidence. Fast fixture PASS는 delegated case first-fail, later `not-run`, context/stderr/reproduction을 검증하지만 duration evidence가 아닙니다 |
...
| v3.9.0 Step 25 / V390-ADD1-11 full-feature exact-ID UI automation coverage matrix | `./server.sh verify-v390-ui-automation-coverage --output-dir <path>`, `./server.sh verify-v390-ui-automation-coverage-contract`, [v390-ui-automation-coverage-matrix.md](./v390-ui-automation-coverage-matrix.md), [project-feature-test-inventory.md](./project-feature-test-inventory.md) exact UI test ID 424개, `OPS-169`/`SAFE-202`, `test/fixtures/v390_ui_automation_coverage_policy.json`, actual native visible-DOM summary | [release-test-records.md](./release-test-records.md) `V390-ADD1-11 full-feature exact-ID correction final` | [release-test-records.md](./release-test-records.md) `V390-ADD1-11 UI 풀테스트`, matrix의 `unsupported-manual` 415개 | full automation coverage, UI 풀테스트 직접 조작, unsupported case PASS, 30분/120분, published metadata, release action evidence. Matrix gate는 prefix/range 판정 제거와 `mapped-with-explicit-gaps`/partial automation evidence만 확인합니다 |
| V390-ADD1-12 Policy v4 UI evidence transition | `./server.sh verify-ui-fulltest-evidence-policy-v4 --summary <summary.json> --output-dir <path>`, `./server.sh verify-ui-fulltest-evidence-policy-v4-contract`, `test/fixtures/ui_fulltest_evidence_policy_v4.json`, [manual-ui-fulltest.md](./manual-ui-fulltest.md), [project-feature-test-inventory.md](./project-feature-test-inventory.md) `OPS-169`/`SAFE-202` | [release-test-records.md](./release-test-records.md) `V390-ADD1-12 Policy v4 final` | [release-test-records.md](./release-test-records.md) `V390-ADD1-12 UI 풀테스트`, current 8/424 부분 evidence | Policy gate PASS 자체, legacy v1/fixture/static/wrapper/screenshot-only, unsupported/not-run/excluded gap을 UI 풀테스트 PASS로 승격하지 않습니다. 전체 UI PASS는 Policy v4-qualified exact case 전수와 교차 시각/반응형/role/security 의무 closure가 필요합니다 |
...
| v3.9.0 (17) Development 16 deferred product owner sign-off | `./server.sh verify-v390-deferred-product-owner-signoff`, `test/fixtures/v390_deferred_product_owner_signoff.json`, [v390-feature-completion-inventory.md](./v390-feature-completion-inventory.md) Deferred Product Owner Sign-off, [project-feature-test-inventory.md](./project-feature-test-inventory.md) `SAFE-214`/`OPS-181` | [release-test-records.md](./release-test-records.md) v3.9.0 `Development 16 owner sign-off RED`, `Development 16 owner sign-off final` | [release-test-records.md](./release-test-records.md) v3.9.0 `Development 16 UI/30분/120분/field 실행` | 역할 기반 owner assignment와 사용자 승인 출처는 개인 담당자 배정 evidence가 아닙니다. sign-off gate를 action/credential/provider/Re-ID 구현, field smoke, UI/longrun, published metadata, release action PASS로 승격하지 않습니다 |
| v3.9.0 (17) Development 17 structure stabilization readiness | `./server.sh verify-v390-structure-stabilization-readiness`, `test/fixtures/v390_structure_stabilization_readiness.json`, [2026-07-08-v390-structure-stabilization-handoff.md](./superpowers/plans/2026-07-08-v390-structure-stabilization-handoff.md), [project-feature-test-inventory.md](./project-feature-test-inventory.md) `SAFE-215`/`OPS-182` | [release-test-records.md](./release-test-records.md) v3.9.0 `Development 17 structure readiness RED`, `Development 17 structure readiness final` | [release-test-records.md](./release-test-records.md) v3.9.0 `Development 17 실제 refactor/UI/longrun` | readiness gate는 `v4.0.0` branch 생성이나 source extraction evidence가 아닙니다. contract/slice 계획을 실제 route/API/UI 리팩터링, UI/longrun, published metadata, release action PASS로 승격하지 않습니다 |
| v3.9.0 (17) Development 18 external field smoke no-device closure | `./server.sh verify-v390-external-field-smoke-no-device-closure`, `test/fixtures/v390_external_field_smoke_no_device_closure.json`, [v390-feature-completion-inventory.md](./v390-feature-completion-inventory.md) Development 18 closure, [project-feature-test-inventory.md](./project-feature-test-inventory.md) `SAFE-216`/`OPS-183` | [release-test-records.md](./release-test-records.md) v3.9.0 `Development 18 no-device closure RED`, `Development 18 no-device closure final` | [release-test-records.md](./release-test-records.md) v3.9.0 `Development 18 external field smoke not-run` | closure verifier는 외부 호출 없이 not-run 기록만 검증합니다. TURN/WHEP, ONVIF, provider 실제 성공이나 field/release PASS evidence가 아닙니다 |
| v3.9.0 current source/readiness reconciliation | current inventory 986개, current acceptance 31-command, Step 20 Development 15~18 및 Review2-21 companion verifier, current review approved/closed 상태 | [release-test-records.md](./release-test-records.md) v3.9.0 `v390 current user approval closure reconciliation`, `v390 current source/readiness reconciliation final`; canonical `./server.sh verify-v390-test-acceptance-bundle --output-dir docs/release-artifacts/v3.9.0/test-acceptance-current-final --run-120` | historical source `8fe583d8`의 974개/26-command evidence와 current final 안정화·30분·120분·UI 미실행 기록 | historical 결과를 current PASS로 재사용하지 않습니다. clean worktree의 current canonical source에서 안정화→31개 feature gate→30분→8-case UI automation/replay→120분→Policy v4 전체 UI→cleanup/evidence 순서로 새 evidence가 필요합니다 |
