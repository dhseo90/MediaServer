...
| V390-REVIEW2-27 current UI evidence hygiene | `test/fixtures/v390_ui_current_evidence_state.json`, `docs/release-artifacts/v3.9.0/historical-invalid-ui-evidence.json`, `./server.sh verify-v390-current-ui-evidence-contract`, current durable coverage matrix | [release-test-records.md](./release-test-records.md) `V390-REVIEW2-27 current evidence final`, `V390-REVIEW2-27 companion stabilization final` | [release-test-records.md](./release-test-records.md) `V390-REVIEW2-27 gated suites` | historical summary/trace는 audit 원문으로만 보존합니다. current not-run/0/423/1 mapping PASS를 actual UI 실행 또는 UI 풀테스트 PASS로 승격하지 않습니다 |
