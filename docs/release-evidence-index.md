...
- Release action: PR #55 `v3.6.0 -> main`은 `guardrails`와 `static-gates` PASS 뒤
  ...
  SSH-signed annotated tag `v3.6.0`의 tag object는
  `67fbb47be4b042074d6d28117e9d77301624b771`, target commit은
  `858cc61e05a6155df8ba3ccfce12765610b728d8`입니다. GitHub API tag verification은
  `verified=true`, `reason=valid`, `verified_at=2026-07-04T13:58:38Z`입니다.
  GitHub Release는 [v3.6.0](https://github.com/dhseo90/MediaServer/releases/tag/v3.6.0)로
  생성했습니다.
...
| 2026-07-04 | v360-release-publication-20260704 | release publication | PR #55 `v3.6.0 -> main` checks `guardrails`/`static-gates` PASS 후 merge commit `858cc61e05a6155df8ba3ccfce12765610b728d8`로 병합. SSH-signed annotated tag `v3.6.0` tag object `67fbb47be4b042074d6d28117e9d77301624b771`, target `858cc61e05a6155df8ba3ccfce12765610b728d8`, GitHub API verification `verified=true`/`reason=valid`, GitHub Release `https://github.com/dhseo90/MediaServer/releases/tag/v3.6.0` 생성 | PASS | 미집계 | 미집계 | 미집계 | GitHub PR/check/tag/release command output 기준 | PR/check/tag/release command output; command-level token split 미집계 | [release-test-records.md](./release-test-records.md) v3.6.0 section, [GitHub Release v3.6.0](https://github.com/dhseo90/MediaServer/releases/tag/v3.6.0), [PR #55](https://github.com/dhseo90/MediaServer/pull/55) |
