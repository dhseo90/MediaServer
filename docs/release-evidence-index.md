...
| v3.9.0 (17) Evidence 13~14 final evidence integrity | `./server.sh verify-v390-final-evidence-integrity --summary docs/release-artifacts/v3.9.0/test-acceptance-final/summary.json`, `./server.sh verify-v390-final-evidence-integrity-contract`, `./server.sh verify-v390-test-acceptance-bundle --output-dir docs/release-artifacts/v3.9.0/test-acceptance-final` | [release-test-records.md](./release-test-records.md) v3.9.0 `Evidence 13 final evidence integrity`, `Evidence 14 independent acceptance final` | [release-test-records.md](./release-test-records.md) v3.9.0 `Evidence 14 120분 조건부 미실행`, `Evidence 14 UI 풀테스트 미실행` | 중복 screenshot, video placeholder, 상수 cleanup, commit/command/first-failure 누락을 허용하지 않습니다. 30분/UI-108~115 자동화 PASS를 exact 424개 UI 풀테스트, 조건 미충족 120분, published metadata, release action PASS로 승격하지 않습니다 |
