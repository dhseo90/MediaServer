...
latest published `v3.6.0` 기준으로 정렬하는 local gate입니다.
...
있을 때만 완료로 기록합니다. 현재 latest published release는 `v3.6.0`입니다.
현재 공개 release tag 기준은 `v3.6.0`입니다. 현재 source tag 기준은 `v3.7.0`입니다.
