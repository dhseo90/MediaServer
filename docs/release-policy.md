...
- ONVIF 실장비 field smoke, YouTube 실제 URL relay, Re-ID default-on, tracker default-on, OC-SORT runtime promotion, VLM runtime/model bundle, real cloud provider call은 v2.3.0 완료 근거가 아닙니다.
```
