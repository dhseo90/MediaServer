...
| v290 S09 PR/main/tag/GitHub Release | PR 생성/merge, main sync, release tag 생성, GitHub Release 생성/갱신 | 이 문서 갱신 시점에는 아직 실행 전입니다. release action 승인 상태라도 실제 PR/main/tag/GitHub Release evidence가 생기기 전에는 PASS로 기록하지 않으며, S09 local readiness PASS로 대체하지 않음 |
