...
| v4.0.0 roadmap contract | `./server.sh verify-v400-roadmap-contract` | v4.0.0 Local Operations Policy and Stabilization 로드맵이 정책/안정화와 v4.1.0 신규 기능을 분리하고, 모든 스텝에 테스트 스크립트 반영 필수를 심었는지 확인합니다. VERSION `4.0.0` baseline, 기능 구현, UI 풀테스트, 30분/120분, published metadata, release action evidence가 아닙니다 |
