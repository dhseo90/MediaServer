...
현재 소스 버전은 `3.9.1`입니다. 최신 공개 GitHub Release는 `v3.9.1` source-only
release이며, 최신 published baseline은 `v3.9.1 Release Correctness and Public Repository Hygiene`입니다.
