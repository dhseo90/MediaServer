...
현재 소스 버전은 `3.4.0`입니다. 최신 공개 GitHub Release는 `v3.4.0` source-only
release이며, 이 문서는 현재 source tree의 UI 구조와 v3.4.0 Operations Continuity Drill Workspace roadmap 경계를 설명합니다.
