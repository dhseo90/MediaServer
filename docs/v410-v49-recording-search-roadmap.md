...
- 2026-09-25 현재 B안: cut·복원·공개 읽기/SQL·증분/회전·형식 전환·소비자 보호·기본 구성과
  현행 검증기 연결(요청1~7)을 마쳤다.8번의 누적 수치 검사는 통과했으나 이전snapshot의
  보관 수명을 추가로 판정해야 한다. 실제 HTTP/통합·9번 최종 코드 고정은 보류하며 S11은 미완료다.
  [현재 요청 대조·릴리즈 잔여](release-artifacts/v4.1.0/b07-scale-integration-20260925/readiness.md).
