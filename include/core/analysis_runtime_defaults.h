// 파일 요약: analysis runtime 설정과 알고리즘 옵션이 공유하는 dependency-free 기본값 계약이다.
// 동작 요약: process AppConfig와 analysis owner가 동일한 compile-time 기본값을 단일 소유권으로 참조한다.
#pragma once

#include <cstddef>
#include <cstdint>

namespace core::analysis_defaults {
