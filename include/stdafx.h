...
inline constexpr int kDefaultAnalysisLoiteringCooldownMs = 10000;
...
inline constexpr std::size_t kDefaultAnalysisZoneOccupancyThreshold = 3;
inline constexpr int kDefaultAnalysisZoneOccupancyMinDwellTimeMs = 5000;
inline constexpr int kDefaultAnalysisZoneOccupancyCooldownMs = 10000;
