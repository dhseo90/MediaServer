#!/usr/bin/env node
// 파일 용도: 제거된 legacy WebRTC browser harness entrypoint의 호환 stub.
// 동작 요약: 현재 제품 UI 기준에서는 verify-ops-client-ui / verify-rule-ui를 사용하도록 명확히 안내한다.

console.error("[browser-check] removed: legacy WebRTC test page browser harness는 제품 UI에서 제거되었습니다.");
