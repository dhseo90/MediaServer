...
import {parsePhases,summarizeSpawnDiagnostic} from './recording_archive_diagnostic_profile.mjs';
...
try{
  ...
  const snapshot=()=>spawnSync(binary,['--snapshot',path.dirname(original)],{encoding:'utf8',timeout:15000,maxBuffer:16384,env:{PATH:process.env.PATH,MEDIA_SERVER_ARCHIVE_PHASE_TRACE:'1'}});
