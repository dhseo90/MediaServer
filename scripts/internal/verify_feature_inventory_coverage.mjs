...
const stabilityVerifierByPrefix = {
  ...
  SRC: ["verify-v230-conditional-field-evidence", "verify-ops-source-lifecycle", "verify-ops-source-health-bulk", "verify-ops-client-ui", "verify-onvif-no-device-suite", "verify-v260-onvif-credential-gate"],
  RULE: ["verify-rule-ui", "verify-ops-rules-roundtrip", "verify-ops-rule-validation-matrix", "verify-va-event-coverage-report", "verify-va-replay", "verify-analysis-state", "verify-v260-scenario-cross-zone-reentry"],
  EVT: ["verify-va-event-coverage-report", "verify-va-events", "verify-ops-event-review-inbox", "verify-ops-event-records-scope", "verify-ops-alert-delivery-integrations", "verify-ops-event-action-incident-workflow", "verify-va-runtime-console", "verify-vlm-event-evidence-extraction", "verify-vlm-observation-sidecar", "verify-vlm-event-explanation-hints", "verify-vlm-review-action-workflow", "verify-vlm-ops-event-review-ui", "verify-vlm-summary-search-candidates", "verify-vlm-rule-suggestion-candidates", "verify-vlm-rule-suggestion-draft-workflow", "verify-v250-incident-text-projection", "verify-v250-incident-memory-index", "verify-v250-ops-events-semantic-search-ui", "verify-v250-incident-timeline-graph", "verify-v250-explainable-incident-brief", "verify-v250-similar-incident-lookup", "verify-v250-redacted-incident-evidence-bundle", "verify-v260-incident-memory-productization", "verify-v260-rule-suggestion-review", "verify-v260-runtime-dashboard-trends", "verify-v260-scenario-cross-zone-reentry", "verify-v270-incident-triage-board", "verify-v270-incident-decision-scorecard", "verify-v270-operational-action-pack", "verify-v270-rule-what-if-preview", "verify-v270-operator-outcome-memory"],
  CLIENT: ["verify-client-live-workspace", "verify-client-dashboard-polish", "verify-client-source-dock-events", "verify-ops-client-ui", "verify-v250-client-safe-incident-digest"],
