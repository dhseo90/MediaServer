...
const stabilityVerifierByPrefix = {
  ...
  SRC: ["verify-v230-conditional-field-evidence", "verify-ops-source-lifecycle", "verify-ops-source-health-bulk", "verify-ops-client-ui", "verify-onvif-no-device-suite", "verify-v260-onvif-credential-gate", "verify-v280-evidence-intake-field-readiness"],
