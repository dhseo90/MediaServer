...
const stabilityVerifierByPrefix = {
  UI: ["verify-auth-bootstrap", "verify-auth-routes", "verify-ops-client-ui", "verify-ops-route-boundaries", "verify-vlm-install-connection-ui", "verify-vlm-profile-storage", "verify-vlm-runtime-opt-in-contract", "verify-vlm-runtime-status-ui", "verify-vlm-evaluation-result-workflow", "verify-vlm-review-action-workflow", "verify-vlm-rule-suggestion-draft-workflow", "verify-vlm-ops-event-review-ui", "verify-vlm-privacy-transfer-guard", "verify-ops-event-action-incident-workflow", "verify-ops-alert-delivery-integrations"],
