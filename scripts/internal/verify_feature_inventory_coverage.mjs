...
const stabilityVerifierByPrefix = {
  UI: ["verify-auth-bootstrap", "verify-auth-routes", "verify-ops-client-ui", "verify-ops-route-boundaries", "verify-vlm-install-connection-ui", "verify-vlm-profile-storage", "verify-vlm-privacy-transfer-guard"],
...
check("inventory row count is stable", () => {
  assert(rows.length === 335, `expected 335 feature rows, found ${rows.length}`);
