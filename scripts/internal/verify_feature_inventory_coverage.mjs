...
const stabilityVerifierByPrefix = {
  ...
  OPS: ["verify-v230-ops-backup-recovery-lifecycle", "verify-ops-backup-recovery-guide", "verify-ops-backup-restore-dry-run", "verify-ops-evidence-retention-cleanup", "verify-v250-owner-release-readiness", "verify-v260-owner-release-readiness"],
};
