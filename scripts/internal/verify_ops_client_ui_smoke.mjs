...
const clientShellMust = [
  ...
  'media-server.client.v350-impact-forecast.v1',
  'client-operations-notice',
  'clientOperationsNotice',
  'viewer-safe operations notice',
  'media-server.client.v350-operations-notice.v1',
];
