...
const pageChecks = [
  ...
  },
  {
    ...
    must: ['data-testid="ops-sources-page"', 'data-testid="onvif-import-panel"', 'id="onvif-import-stub"', 'id="onvifImportSummary"', '/ops/api/onvif/import-draft', 'data-testid="channel-bulk-panel"', 'id="channel-bulk-select-all"', 'id="channelBulkDiagnostics"', 'id="channels-body"', 'id="channel-detail-panel"', 'name="whepUrl"', "ONVIF Live Source import", "외부 WHEP URL", "Published WebRTC", "Published sourceId"],
