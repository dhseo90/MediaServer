...
const pageChecks = [
  ...
  },
  {
    name: "client-events",
    path: "/client/events",
    must: ['data-testid="client-shell-page"', 'data-client-active="events"', 'id="views"', 'id="detail"', 'client-viewer-events', 'data-viewer-flow="events-first"', 'client-safe-incident-digest', 'incidentDigest', 'viewer-safe incident digest', 'client-safe-followup-digest', 'followUpDigest', 'viewer-safe follow-up digest'],
    shellMust: clientShellMust,
    mustNot: clientForbiddenText(),
  },
];
