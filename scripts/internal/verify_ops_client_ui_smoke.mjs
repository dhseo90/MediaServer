...
const pageChecks = [
  ...
  },
  {
    ...
    visualSelector: '[data-testid="client-shell-page"]',
    must: ['data-testid="client-shell-page"', 'data-client-active="dashboard"', 'id="views"', 'id="detail"', 'data-testid="client-dashboard-compare"', 'loadClientDashboardCompare', 'client-safe-incident-digest', 'incidentDigest', 'viewer-safe incident digest', 'data-client-copy="status"', 'data-client-copy="events"'],
    shellMust: clientShellMust,
  ...
  },
  {
    name: "client-events",
    path: "/client/events",
    must: ['data-testid="client-shell-page"', 'data-client-active="events"', 'id="views"', 'id="detail"', 'client-viewer-events', 'data-viewer-flow="events-first"', 'client-safe-incident-digest', 'incidentDigest', 'viewer-safe incident digest'],
    shellMust: clientShellMust,
    mustNot: clientForbiddenText(),
  },
];
