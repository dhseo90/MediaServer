...
const pageChecks = [
  ...
  },
  {
    ...
    must: ['data-testid="ops-vlm-page"', 'data-testid="ops-vlm-controls"', 'data-testid="ops-vlm-runtime-status-panel"', 'data-testid="ops-vlm-options-panel"', 'data-testid="ops-vlm-privacy-transfer-guard-panel"', 'data-testid="ops-vlm-profile-panel"', 'data-testid="ops-vlm-boundary-panel"', 'id="opsVlmProviderStatus"', 'id="opsVlmRuntimeConnectionStatus"', 'id="opsVlmLastEvaluationStatus"', 'id="opsVlmFailureReason"', 'id="opsVlmDefaultOffStatus"', 'id="opsVlmExternalTransferWarningAck"', 'id="opsVlmProviderLoggingReviewed"', 'id="opsVlmPrivacyGuardList"', 'id="opsVlmSaveProfile"', '/ops/api/runtime/status', '/ops/api/vlm/install-connection/dry-run', '/ops/api/vlm/profiles', 'media-server.vlm-privacy-transfer-guard.v1', 'credential, prompt, raw response, source URL, raw frame bytes'],
