...
async function assertRemainingSourceReadModels(onvifDraft, sourceCountBeforeDraft, sourceCountAfterDraft) {
  ...
  assert(clientProjectionRaw.includes('"sourceKind":') && sourceUrlExposed === false && rawLocatorExposed === false && credentialMaterialExposed === false, "SRC-029 sourceKind client projection source URL redaction runtime readback failed");
