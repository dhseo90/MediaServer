...
if(!['red','green'].includes(mode)||!['envelope','accepted','binding','job'].includes(suite)||!id||!/^[a-z0-9-]{1,40}$/.test(id)||extra.length)throw Error('LP18_ARGUMENTS');
