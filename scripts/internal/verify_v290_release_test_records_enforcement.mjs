...
check("feature inventory maps V290-S04 to OPS-045 and SAFE-075", () => {
  ...
  assert(projectInventoryVerifier.includes("`SAFE-001`~`SAFE-075`"), "project inventory verifier missing SAFE-075 range");
  assert(projectInventoryVerifier.includes("`OPS-035`~`OPS-045`"), "project inventory verifier missing OPS-045 range");
});
