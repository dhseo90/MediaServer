#!/usr/bin/env node
// 파일 용도: v3.2.0 source baseline 정렬과 v3.1.0 published metadata 경계를 검증한다.
...
Checks:
  - VERSION/CMake and public docs identify source 3.2.0 while latest published release is v3.1.0
...
check("public entry docs pin source v3.2.0 and published v3.1.0", () => {
...
check("policy docs pin v3.2 active source and v3.1 published release", () => {
...
check("release metadata and docs UI asset verifiers know source v3.2 and published v3.1 baseline", () => {
