...
check("inventory coverage and server entrypoint include v3.3 Step 1", () => {
  ...
  assert(files.projectInventoryVerifier.includes("`SAFE-001`~`SAFE-119`"), "project inventory verifier missing V330 SAFE range");
  assert(files.projectInventoryVerifier.includes("`OPS-035`~`OPS-086`"), "project inventory verifier missing V330 OPS range");
