...
check("server entrypoint and inventory verifiers include v3.3 Step 2 command", () => {
  ...
  assertIncludes(files.projectInventoryVerifier, "`SRC-001`~`SRC-033`", "project inventory SRC range");
  assertIncludes(files.projectInventoryVerifier, "`SAFE-001`~`SAFE-114`", "project inventory SAFE range");
  assertIncludes(files.projectInventoryVerifier, "`OPS-035`~`OPS-081`", "project inventory OPS range");
