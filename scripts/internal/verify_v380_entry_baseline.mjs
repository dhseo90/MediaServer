...
check("server entrypoint and inventory verifiers include v3.8 Step 1", () => {
  ...
  assertIncludes(files.projectInventoryVerifier, "`SAFE-001`~`SAFE-181`", "project inventory SAFE range");
  assertIncludes(files.projectInventoryVerifier, "`OPS-035`~`OPS-148`", "project inventory OPS range");
