...
std::string ProductSharedUiScript() {
    ...
    window.MediaServerUi = window.MediaServerUi || (() => {
      ...
      const koToEn = new Map(Object.entries({
        ...
        'ONVIF 후보를 저장 전 draft로 가져와 채널 폼에서 확인합니다.': 'Import ONVIF candidates as pre-save drafts and review them in the channel form.',
        'Stub 후보 가져오기': 'Import stub candidates',
        '카메라가 없어도 stub 후보로 import draft와 채널 폼 연결을 확인할 수 있습니다.': 'Use stub candidates to check import drafts and channel-form wiring without a camera.',
        ...
        '프레임/메타데이터 수신 상태와 운영 조치 대상을 확인합니다.': 'Review frame/metadata receiving status and operator action targets.',
        '상태 재확인': 'Refresh status',
        'Bulk 체크': 'Bulk check',
        'Bulk 재시도': 'Bulk retry',
        'source health를 불러오는 중입니다.': 'Loading source health.',
        '채널을 선택하면 Live Source Health가 표시됩니다.': 'Select a channel to show Live Source Health.',
        '프레임/메타데이터 수신': 'Receiving frame/metadata',
        'source health 미조회': 'Source health not checked',
        '수신 중인 source health가 정상 범위입니다.': 'Receiving source health is within normal range.',
        'Live Source Health가 아직 조회되지 않았습니다.': 'Live Source Health has not been checked yet.',
        '라이브 URL': 'Live URL',
        'VA URL': 'VA URL',
